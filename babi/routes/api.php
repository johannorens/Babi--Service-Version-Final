...
Route::post('prestataires/candidature', [
    PrestataireController::class,
    'candidater'
]);
...
Route::middleware(['auth:sanctum', 'admin'])->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::patch('prestataires/{id}/valider', [
            AdminDashboardController::class,
            'validerPrestataire'
        ]);


        Route::patch('prestataires/{id}/rejeter', [
            AdminDashboardController::class,
            'rejeterPrestataire'
        ]);
        ...
        Route::delete('utilisateurs/prestataires/{id}', [
            AdminDashboardController::class,
            'deletePrestataire'
        ]);
